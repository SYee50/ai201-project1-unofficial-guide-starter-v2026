...
- Response time: 12.25 seconds
- Best distance: 0.4009 (passed the gate)
- Sources retrieved: housing_aldridge_hall_noise.txt, housing_calder_annexe_noise.txt, housing_innisfree_hall_noise.txt, housing_old_brewhouse_noise.txt, housing_tamsin_court_noise.txt

```
Based on the provided documents, if you need quiet to work, the library is open until 2am during term (from housing_tamsin_court_noise.txt, housing_aldridge_hall_noise.txt, housing_old_brewhouse_noise.txt, housing_calder_annexe_noise.txt, and housing_innisfree_hall_noise.txt). Additionally, floors 3 and 4 in Aldridge Hall are genuinely quiet and enforced (from housing_aldridge_hall_noise.txt).
```
...
- Response time: 23.91 seconds
- Best distance: 0.3840 (passed the gate)
- Sources retrieved: course_cs_210_workload.txt, course_cs_340.txt, course_econ_101_workload.txt, course_stat_150_workload.txt, money_jobs.txt

```
The maximum amount of hours students can work on campus during the term is 20 hours a week (money_jobs.txt).
```

### What is the maximum amount of hours students can work on campus each week during term? — run 3

- Response time: 571.78 seconds
- Best distance: 0.3840 (passed the gate)
- Sources retrieved: course_cs_210_workload.txt, course_cs_340.txt, course_econ_101_workload.txt, course_stat_150_workload.txt, money_jobs.txt

...
| Where is a quiet location on campus? |   |   |   |
| When is the best time to do laundry? |   |   |   |
| How far in advance do students need to book study rooms? |   |   |   |
| What is the maximum amount of hours students can work on campus each week during term? |   |   |   |
...
```
The maximum amount of hours students can work on campus each week during term is 20 hours (money_jobs.txt).
```
...
```
The maximum amount of hours students can work on campus during term is 20 hours a week (money_jobs.txt).
```
